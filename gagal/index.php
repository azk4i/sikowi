...
<head>
  ...
  <link rel="shortcut icon" href="../auth/assets/img/wibu2.png">
...
<body class="page-loading">
        ...
        <div class="card-block">
          <form role="form" class="form-layout" action="" method="post">
            <div class="text-center m-b">    
              ...
              <img src="../auth/assets/img/wibuputih.png" style='width:350px; height:250px;'/> 
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog modal-md">
      ...
      iv <button type="button" class="btn btn-danger" data-dismiss="modal" style="background-color:#bb0a1e;"><font color="#ffffff"><b> TUTUP </b></font></button>
        </div>
      </div>
    </div>
  </div>
